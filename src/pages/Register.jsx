...
import { registerOwner } from '../api/ownerService';
...
const Register = () => {
  ...
  return (
    <div className="card max-w-full md:max-w-md mx-auto my-8 md:my-16 rounded-lg md:rounded-xl shadow-lg p-4 md:p-8 font-sans w-full">
      <h2 className="text-[color:var(--accent)] mb-4 font-bold text-lg md:text-xl tracking-wide">Owner Registration</h2>
      <a
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 w-full">
        ...
        {success && <div className="text-green-500 mt-2 text-center">Registration successful! Redirecting to login...</div>}
      </form>
      <div className="text-xs text-gray-400 text-center mt-6">
        Already have an account? <a href="/login" className="text-[color:var(--accent)] underline">Login</a>
      </div>
    </div>
  );
};
